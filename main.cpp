...
////    do
////    {
////        std::cout << "Enter the complete path of the .csv file: ";
////        std::cin >> filePath;
////        // Check if file path exists
////        if (!filesystem::exists(filePath))
////            std::cout << "This file does not exist. Please try again." << endl;
...
////
////    filesystem::path treeDir = "MerkleTreeFiles";
////    MerkleTree merkleTree(hashChoice, treeDir);
////
////    //create leaf nodes queue
////    Queue<filesystem::path>leafNodes = merkleTree.createLeafNodes(filePath.string().c_str()); //convert to char array 
////    if (leafNodes.is_empty())
////        cout << "No leaf nodes made for Merkle Tree" << std::endl;
////
////    //build tree
...
////    //    int hashKey = hashOurKey(rowData);
////    //    std::cout << "INSERTING: " << hashKey << " with value: " << fieldValue << endl;
////    //    avlTree.insert(hashKey, fieldValue, rowData);
////    //}
////
////    ////set hash choice here
////    //avlTree.hashChoice = hashChoice;
////    //Queue<char*> avlhashes;
////    //avlTree.getAllHashes(avlhashes);
////    //avlhashes.print();
////    ////------------------------------------------EXITING THE AVL TREE DIRECTORY-------------------------------------------------------------
////    //filesystem::current_path(originalDirectory); //return to original
////
////   /* Queue<char*> merkleHashes;
////    merkleTree.getAllHashes(merkleHashes);
////    cout << "\nmerkle: " << endl;
////    merkleHashes.print();*/
////
////    //------------------------------------------------------------------------------------------------------------------------
...
////    //    int hashKey = hashOurKey(rowData);
////    //    std::cout << "INSERTING: " << hashKey << " with value: " << fieldValue << endl;
////    //    rbt.insert(hashKey, fieldValue, rowData);
////    //}
////
